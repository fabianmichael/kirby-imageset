...
if(!defined('PARENT_KIRBY_ROOT')) define('PARENT_KIRBY_ROOT', dirname(TEST_ROOT) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..');

// set the timezone for all date functions
date_default_timezone_set('UTC');

// include the kirby bootstrapper file
require_once(PARENT_KIRBY_ROOT . DIRECTORY_SEPARATOR . 'kirby/bootstrap.php');
